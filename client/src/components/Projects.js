      ...
      <div className="container">
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', justifyContent: 'center', maxWidth: '900px', margin: '0 auto' }}>
          {projects.map((project) => (
            project.title.includes('Virtuel Elegance') ? (
              <div
                className="card"
                key={project.id}
                style={{
              ...
              >
                ...
                {windowWidth > 700 && (
                  <div style={{ width: '50%', minWidth: 0, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#181818' }}>
                    <img src={project.image} alt={project.title} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', borderRadius: '0' }} />
                  </div>
                )}
                {/* Right: Content */}
                <div style={{ width: windowWidth <= 700 ? '100%' : '50%', minWidth: 0, padding: windowWidth <= 700 ? '12px 8px' : '32px 24px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  {/* Project Title and Badge */}
                  <div style={{ marginBottom: '12px' }}>
                    <h3 style={{
                      margin: '0 0 8px 0',
                      color: '#ffffff',
                      fontSize: windowWidth <= 700 ? '1rem' : '1.3rem',
                      fontWeight: 700,
                    ...
                    <div style={{
                      fontSize: windowWidth <= 700 ? '0.8rem' : '0.9rem',
                      color: '#ffb300',
                      fontWeight: 600,
                      fontStyle: 'italic',
                  ...
                  <ul style={{
                    ...
                    <li style={{ marginBottom: '8px', position: 'relative' }}>
                      <span style={{ position: 'absolute', left: '-15px', top: '6px', width: '4px', height: '4px', borderRadius: '50%', background: '#ffb300' }}></span>
                  ...
                  <div style={{ margin: '16px 0' }}>
                    <div style={{ fontSize: windowWidth <= 700 ? '0.8rem' : '0.9rem', color: '#ffb300', fontWeight: 600, marginBottom: '8px', fontStyle: 'italic', fontFamily: 'Times New Roman, Times, serif' }}>
                      Technologies
                    </div>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                      {project.technologies.map((tech, idx) => (
                        <span key={idx} style={{ background: 'linear-gradient(135deg, #4a4a4a 0%, #3a3a3a 100%)', color: 'white', borderRadius: '16px', padding: '4px 10px', fontSize: windowWidth <= 700 ? '0.7rem' : '0.8rem', border: '1px solid #555', fontWeight: 500 }}>
                          {tech}
                        </span>
                      ))}
                    </div>
                  ...
                  <a
                    ...
                    style={{
                      ...
                      textDecoration: 'none',
                      fontWeight: 700,
                      fontSize: windowWidth <= 700 ? '0.9rem' : '1rem',
                      transition: 'all 0.3s ease',
                      marginTop: 'auto'
                    }}
                    onMouseEnter={(e) => {
